...
(function($) {
	function TouchCarousel(element, options) {	
		...
		if(this.settings.directionNav) {	
			this._itemsWrapper.after("<a href='#' class='arrow-holder left'><span class='arrow-icon left'><i class='fa fa-caret-left'></i></span></a> <a href='#' class='arrow-holder right'><span class='arrow-icon right'><i class='fa fa-caret-right'></i></span></a>");
